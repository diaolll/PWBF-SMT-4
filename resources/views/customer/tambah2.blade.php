...
@section('content')
    ...
    <div class="page-header">
        <div>
            ...
            <h2 style="margin-top: 0.5rem;">Tambah Customer (File)</h2>
        </div>
    </div>

    <form class="form-card" method="POST" action="{{ route('customer.store2') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        ...
                        <small id="cameraStatus" class="badge bg-secondary ms-2">BELAKANG</small>
                    </h5>
