...
{{-- ===== SIDEBAR ===== --}}
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item nav-profile">
                    <a href="#" class="nav-link">
                        <div class="nav-profile-image">
                            <img src="{{ Auth::user()->avatar ?? asset('assets/images/faces/face1.jpg') }}"
                                 alt="profile" />
                ...
                {{-- Generate Dokumen --}}
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ui-pdf-gen"
                    ...
                    <div class="collapse" id="ui-pdf-gen">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <h6 class="ps-4 text-muted small mt-2">Sertifikat</h6>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/generate-sertifikat') }}" target="_blank">
                                    Lihat Sertifikat
                                </a>
                            </li>
                            <div class="dropdown-divider"></div>
                            <li class="nav-item">
                                <h6 class="ps-4 text-muted small mt-2">Surat Undangan</h6>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/generate-surat') }}" target="_blank">
                                    Lihat Surat
                                </a>
                            </li>
                        </ul>
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ui-modul4"
                       aria-expanded="false" aria-controls="ui-modul4">
                    ...
                    <div class="collapse" id="ui-modul4">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/modul/table-datatable') }}">
                                    Table Datatable
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/modul/select-kota') }}">
                                    Select Kota
                                </a>
                            </li>
                            <!-- <li class="nav-item">
                ...
                {{-- Modul 5 --}}
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ui-modul5"
                       aria-expanded="false" aria-controls="ui-modul5">
                        <span class="menu-title">Modul 5</span>
                        <i class="menu-arrow"></i>
                        <i class="mdi mdi-lightning-bolt menu-icon"></i>
                    </a>
                    <div class="collapse" id="ui-modul5">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
