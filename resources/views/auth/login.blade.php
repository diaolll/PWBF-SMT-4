  ...
  <div class="row flex-grow">
    <div class="col-lg-4 mx-auto">
      <div class="auth-form-light text-left p-5">
        ...
        <div class="text-center mt-4 mb-2 text-muted font-weight-light">
          — Atau login dengan —
        </div>

        <div class="d-grid gap-2">
          <a href="{{ url('auth/google') }}" class="btn btn-block btn-outline-dark btn-lg font-weight-medium auth-form-btn" style="display: flex; align-items: center; justify-content: center; border: 1px solid #ebedf2; text-decoration: none; color: #333;">
            <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" width="18" style="margin-right: 10px;"> 
            Google Account
          </a>
        </div>
        <div class="my-2 d-flex justify-content-between align-items-center mt-4">
